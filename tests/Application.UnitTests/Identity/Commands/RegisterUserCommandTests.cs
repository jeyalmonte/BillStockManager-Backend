...
public class RegisterUserCommandTests
{
    ...
    [Fact]
    public void RegisterUserCommand_ShouldReturnValidationError_WhenUsernameIsEmpty()
    {
        // Arrange
    ...
    [Fact]
    public async Task RegisterUserCommand_ShouldReturnError_WhenRegisterFails()
    {
        // Arrange 
